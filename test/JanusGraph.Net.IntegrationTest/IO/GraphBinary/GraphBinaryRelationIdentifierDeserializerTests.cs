...
namespace JanusGraph.Net.IntegrationTest.IO.GraphBinary
{
    ...
    public class GraphBinaryRelationIdentifierDeserializerTests : RelationIdentifierDeserializerTests
    {
        public GraphBinaryRelationIdentifierDeserializerTests(JanusGraphServerFixture fixture)
        {
